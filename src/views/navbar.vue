  ...
  <nav class=" bg-white dark:bg-gray-500">
    <div class="flex flex-wrap justify-between items-center mx-auto w-full px-4 md:px-6 py-2.5">
      ...
      <div class="flex items-center px-4">
        ...
        <a :href= "'tel:'+phone_number" class="mr-6 w-full text-sm font-medium text-blue-900 dark:text-white hover:underline">{{ "Llamar al: "+ phone_number }}</a>
        <p class="mr-6 text-sm w-full font-medium text-blue-900 dark:text-white hover:underline"> {{"Correo electrónico: "+ email }}</p>
      </div>
